...
export default function RegisterPage() {
  ...
  <img src="/logo.png" alt="Devexy Logo" className="h-12 w-auto" />
            ...
            <h2 className="text-3xl font-bold text-center mb-2">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-green-600">Create Account</span>
            </h2>
            <p className={`text-center mb-8 ${darkMode ? "text-gray-300" : "text-gray-500"}`}>Sign up for your DevExy account</p>
          </motion.div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.6 }}>
              <label className={`block ${darkMode ? "text-gray-200" : "text-gray-700"} font-medium mb-2`}>Email</label>
              <input
                type="email"
                value={email}
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.7 }}>
              <label className={`block ${darkMode ? "text-gray-200" : "text-gray-700"} font-medium mb-2`}>Full Name</label>
              <input
                type="text"
                value={fullName}
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.8 }}>
              <label className={`block ${darkMode ? "text-gray-200" : "text-gray-700"} font-medium mb-2`}>GitHub Username</label>
              <input
                type="text"
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.9 }}>
              ...
              <input
                ...
                required
              />
              <p className={`mt-1 text-sm ${darkMode ? "text-gray-400" : "text-gray-500"}`}>Password must be at least 8 characters long</p>
            </motion.div>

            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 1.0 }}>
              <label className={`block ${darkMode ? "text-gray-200" : "text-gray-700"} font-medium mb-2`}>Confirm Password</label>
              <input
                type="password"
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 1.2 }} className="mt-8 text-center">
            <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>
              ...
              <motion.a whileHover={{ scale: 1.05 }} href="/login" className="text-green-500 hover:text-green-600 font-medium transition-colors duration-200">
                Log in here
              </motion.a>
            </p>
          </motion.div>
      ...
      <motion.div initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 0.7, scale: 1 }} transition={{ duration: 0.8, delay: 1.3 }} className="fixed bottom-0 left-0 w-64 h-64 bg-gradient-to-r from-green-300 to-green-400 rounded-full -mb-32 -ml-32 blur-2xl opacity-20 z-0" />
      <motion.div initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 0.7, scale: 1 }} transition={{ duration: 0.8, delay: 1.4 }} className="fixed top-0 right-0 w-80 h-80 bg-gradient-to-l from-green-300 to-green-400 rounded-full -mt-40 -mr-40 blur-2xl opacity-20 z-0" />
